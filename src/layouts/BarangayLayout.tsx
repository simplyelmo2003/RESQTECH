...
const BarangayLayout: React.FC<BarangayLayoutProps> = ({ children }) => {
  const { user } = useAuth(); // Assuming 'barangay' role is guaranteed by ProtectedRoute
